...
public class CharCtrl : MyMonoBehaviour
{
	...
	// --- Thêm Particle Controller ---
	[SerializeField] protected ParticleEffectsController particleEffectsController;
	public ParticleEffectsController ParticleEffectsController => particleEffectsController;
	...
	protected override void LoadComponents()
	{
		...
		this.LoadParticleEffectsController(); // <- thêm vào đây
	}
	...
	// --- Hàm load thêm Particle Controller ---
	protected virtual void LoadParticleEffectsController()
	{
		if (particleEffectsController != null) return;
		particleEffectsController = GetComponentInChildren<ParticleEffectsController>();
		Debug.LogWarning(transform.name + ": LoadParticleEffectsController", gameObject);
	}
}
