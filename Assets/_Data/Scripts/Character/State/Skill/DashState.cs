...
public class DashState : ICharState<CharBaseState>
{
    ...
    public void OnEnter(CharBaseState context)
    {
        ...
        context.CharCtrl.CharStateCtrl.VelocityHandle.Request(0f, 0f, SVelocityPriority.Skill);
    ...
    public void OnPhysicUpdate(CharBaseState context)
    {
        ...
        context.CharCtrl.CharStateCtrl.VelocityHandle.RequestX(dir * dashSpeed, SVelocityPriority.Skill);
    }
}
