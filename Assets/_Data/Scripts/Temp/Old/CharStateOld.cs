...
public class CharStateOld : BaseState<CharStateOld>
{
    [Header("StateMachine")]
    ...
    protected virtual void LoadCheckGroundBox()
    {
        ...
        boxSize = new Vector2(charCtrl.CharBodyCollider.bounds.size.x - 0.02f, 0.05f);
    }

    protected virtual void CheckGrounded()
    {
        Vector2 boxCenter = new Vector2(charCtrl.CharBodyCollider.bounds.center.x, charCtrl.CharBodyCollider.bounds.min.y - 0.01f);
    ...
    private void OnDrawGizmos()
    {
        Vector2 boxSize = new Vector2(
            charCtrl.CharBodyCollider.bounds.size.x - 0.02f,
            0.05f
        );

        Vector2 boxCenter = new Vector2(
            charCtrl.CharBodyCollider.bounds.center.x,
            charCtrl.CharBodyCollider.bounds.min.y - 0.01f
        );
